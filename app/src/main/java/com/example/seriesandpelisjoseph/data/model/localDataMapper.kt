...
fun Serie.toSerieWithTemporadas() : SeriesWithTemporadas {
    ...
    return SeriesWithTemporadas(this.toSerieEntity(),this.temporadas?.map { it.toTemporadasWithCapitulos() })

}

fun Temporada.toTemporadasWithCapitulos() : TemporadasWithCapitulos {
    return TemporadasWithCapitulos(this.toTemporadaEntity(),this.capitulos?.map { it.toCapituloEntity() })
}
...
fun SeriesWithTemporadas.toMultimedia() : MultiMedia {
    return MultiMedia(this.serie.idSerie
        ,this.serie.idApi
        ,this.serie.imagen
...
fun MovieWithActores.toMultimedia() : MultiMedia {
    return MultiMedia(this.movie.idMovie
        ,this.movie.idApi
        ,this.movie.imagen
